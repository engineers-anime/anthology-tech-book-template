...
プロジェクトの各種進捗状況は、GitHub Actions により自動的に Discord に通知されます。

- **相互レビュー進捗状況**: Issue の作成やコメントなどのアクションがあった際に、最新の進捗状況が Discord へ通知されます。
- **執筆宣言・未登録者リスト**: 新たな執筆宣言があった際や、`book.json` が更新された際に、未登録者の一覧が Discord へ通知されます。
